...
<%@page import="com.recipes.entity.Tips"%>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         ...
         <a style="margin-bottom: 4px;" class="btn btn-primary pull-right" href="createTips.jsp">Create Tips</a>
          ...
          <table class="table table-bordered table-hover">
              ...
              <tr>
                  ...
                  <td><%=t.getTips()%></td>
                  <td>
                    <a href="../AdminP?deleteTips=<%=t.getId() %>" onclick='return confirm("Are you sure?")' class="btn btn-danger">Delete</a>
                  </td>
              </tr>
              <% } %>
          </table>
